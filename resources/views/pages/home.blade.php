                ...
                <div class="flex flex-wrap items-center justify-center gap-2 mt-6">
                    ...
                    @foreach($categories as $cat)
                        <button @click="activeTab = '{{ $cat->slug }}'" 
                                :class="activeTab === '{{ $cat->slug }}' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-700 hover:bg-slate-100 border border-slate-200'"
                                class="px-4 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer">
                            {{ $cat->name }}
                        </button>
                    @endforeach
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    @foreach($categories as $cat)
                        <button @click="galleryTab = '{{ $cat->slug }}'" 
                                :class="galleryTab === '{{ $cat->slug }}' ? 'bg-amber-500 text-slate-950 font-black' : 'bg-slate-100 text-slate-700 hover:bg-slate-200 font-semibold'"
                                class="px-3.5 py-1.5 rounded-lg text-xs transition-colors cursor-pointer">
                            {{ $cat->name }}
                        </button>
                    @endforeach
