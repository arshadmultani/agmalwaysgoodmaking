...
set('repository', 'https://github.com/arshadmultani/agmalwaysgoodmaking.git');
...
host('agmalwaysgoodmaking.in')
    ->set('remote_user', 'exponit')
    ->set('deploy_path', '~/agmalwaysgoodmaking')
    ->set('port', 22999)
...
// Build Vite assets locally and commit public/build to git; the deploy then
// clones them with the code (the shared host has no rsync for uploads).
...
task('db:pull', function () {
    $snapshot = '/tmp/agmalwaysgoodmaking-db-pull.sqlite';
